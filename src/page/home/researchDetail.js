    ...
    <View style={{
       ...
       flexDirection:"row",
          ...
          <View style={{width:width*0.8,alignItems:"center"}}> 
             <Text style={{fontSize:19,fontFamily:'Prompt-Regular'}}>ความรู้วิจัย</Text>
          </View>      
          <TouchableOpacity
        ...
        <View style={{width:width*0.9,height:height*0.1,justifyContent:"center",alignSelf:"center"}}>
             <Text style={styles.Text18}>ตัวอย่างงานวิจัย</Text>
        </View>

        <View style={{width:width*0.9,alignSelf:"center"}}> 

        <Text style={styles.Text8}>โดย แอดมิน เมื่อ 30 / 03 / 2564  12:00 น.</Text>
...
const styles = StyleSheet.create({
  ...
  Text8:{width:width*0.9,fontSize:8,fontFamily:"Prompt-Regular",color:"#444444"},
  Text12:{width:width*0.9,fontSize:12,fontFamily:"Prompt-Regular",color:"#444444",marginTop:20},
