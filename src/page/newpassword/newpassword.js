    ...
    <View style={styles.container}>
     <SafeAreaView/>
      <KeyboardAwareScrollView>
         ...
         <Text style={{fontFamily:"Prompt-Regular",fontSize:30,color:"#4B4B4B"}}>เปลี่ยนรหัสผ่านใหม่</Text> 
          
          <View style={{width:width*0.891,height:height*0.040,flexDirection:"row",justifyContent:"space-between",alignItems:"center",marginTop:15}}>
            <Text style={{fontFamily:"Prompt-Regular"}}>รหัสผ่านใหม่</Text>
          ...
          <View style={{width:width*0.891,height:height*0.040,flexDirection:"row",justifyContent:"space-between",alignItems:"center",marginTop:15}}>
            <Text style={{fontFamily:"Prompt-Regular"}}>ยืนยันรหัสผ่านใหม่</Text>
            <TextInput style={styles.Text2}
            // onChangeText={(mail) => setmail(mail)}
            // defaultValue={mail}
            />
...
const styles = StyleSheet.create({
  ...
  Text2:{width: width * 0.588,height:height*0.040,fontFamily:"Prompt-Regular",fontSize:16,color:"#4B4B4B90",borderWidth:1,borderRadius:5,borderColor:"#4E4E4E40",backgroundColor:"#ffff",paddingLeft:5},
